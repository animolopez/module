# import modules
# contributed by kabewall
# change default value of fs

import numpy as np
import matplotlib.pyplot as plt
import scipy.fftpack as fft

def fig_time(signal, fs=44100, title="wave form", xaxis="time", label="signal", legend=False):
...
def fig_freqz(signal, fs=44100, title="Frequency Characteristic", label="signal", legend=False):
...
def fig_all(signal, fs=44100, num=1, time_title="Signal wave", time_xaxis="time", freqz_title="Frequency Responce", suptitle="Signal", label="signal"):
